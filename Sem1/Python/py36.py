...
side_length = float(input("Enter the side lengthof the square: "))
rectangle_length = float(input("Enter the length of the rectangle: "))
rectangle_width = float(input("Enter the width ofthe rectangle: "))
triangle_base = float(input("Enter the baselength of the triangle: "))
